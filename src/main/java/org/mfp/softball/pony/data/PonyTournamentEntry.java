 ...
 *
 */
public class PonyTournamentEntry extends BaseTournamentEntry { 
	private String eventAge = null;
	private String teamAge = null;
	private String cityState = null;
	
	public PonyTournamentEntry(String name, String eventAge, String teamAge, String cityState) {
		super(name);
		logger = LogManager.getLogger(PonyTournamentEntry.class.getName());
	...
	public String toString() {
		return "PonyTournamentEntry [eventAge=" + eventAge + ", teamAge="
